...
DWORD GetModuleBaseAddress(std::wstring lpszModuleName, DWORD PID);
...
int ReadMemoryInt(HANDLE hProc, DWORD PID, std::wstring moduleName, DWORD base_offset, std::vector<DWORD> offset) {
	DWORD BaseAddr = GetModuleBaseAddress(moduleName, PID);
	DWORD pointer = 0;
